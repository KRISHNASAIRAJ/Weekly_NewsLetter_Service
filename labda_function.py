...
def lambda_handler(event, context):
    ...
    bucket_name = 'email-marketing-ntl' # Replace with your bucket name
    ...
    try:
        ...
        for contact in contacts:
            ...
            response = ses_client.send_email(
                Source='krishnasairaj.ponneboina@gmail.com',  # Replace with your verified "From" address
                Destination={'ToAddresses': [contact['Email']]},
                Message={
                    'Subject': {'Data': 'Weekkly Big Data Insights: Unlocking Data Value', 'Charset': 'UTF-8'},
